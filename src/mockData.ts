...
const mkArticle = (id: string, title: string, subTitle: string, slug: string, author: string, cats: string[], tags: string[], text: string, wc: number, date: string, likes: number, comments: number, views: number): MockArticle => ({
  _id: id, title, subTitle, slug,
  metaTitle: title.slice(0, 60), metaDescription: subTitle, metaKeywords: tags, metaImage: `/mock/${id}.jpg`,
  ...
  coverImage: `/mock/${id}.jpg`, audioUrl: "", description: subTitle,
