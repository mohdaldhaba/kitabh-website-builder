...
function buildSidebarSections(plan: Plan): SidebarSection[] {
  ...
  return [
    ...
    },
    {
      ...
      planTier: 'writers',
      items: applyMeta([
        { page: 'newsletters', label: 'النشرات البريدية', icon: icons.emailJourney, ...(plan === 'writers' && { tag: 'أساسي' }) },
        { page: 'subscribers', label: 'المشتركون', icon: icons.audience, ...(plan === 'writers' && { tag: 'أساسي' }) },
    ...
    },
    {
      ...
      planTier: 'writers',
      items: applyMeta([
        { page: 'website', label: 'الموقع الإلكتروني', icon: icons.website, ...(plan === 'writers' && { tag: 'أساسي' }) },
        { page: 'landing-pages' as Page, label: 'صفحات الاشتراك', icon: icons.landingPage, ...(plan === 'writers' && { tag: 'أساسي' }) },
...
function buildUtilityItems(plan: Plan): SidebarItem[] {
  ...
  return [
    ...
    { page: 'support' as Page, label: 'الدعم الفني', icon: icons.support, locked: locks.has('support'), planTier: getPlanTier('support'), ...(plan === 'writers' && { tag: 'أساسي' }) },
