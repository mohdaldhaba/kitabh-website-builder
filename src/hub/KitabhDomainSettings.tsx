...
const CSS_STYLES = `
/* Base */
.kds{font-family:'IBM Plex Sans Arabic',system-ui,sans-serif;direction:rtl;text-align:right;color:#111;line-height:1.6;width:100%;max-width:900px;margin:0 auto;}

/* Page Header */
.kds-page-header{padding:0;}
